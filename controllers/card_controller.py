...
@cards_bp.route("/")
def get_all_cards():
    # fetch all cards but order them according to date in descending order (extra lil feature)
...
def create_card():
    ...
    card = Card(
        ...
        date=date.today(), # make sure to import library "from datetime import date"
...
@jwt_required() # user has to be logged in to delete
